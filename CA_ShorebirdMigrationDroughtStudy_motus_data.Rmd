...
# rth, lc4, canebrake
df.247.serno = c("CTT-957865AC5BF7", "CTT-C0612F7F986B", "CTT-27532C924059")
...
df.458.serno = c("CTT-D00F694B4918", "CTT-ECDC2345F5CC", "CTT-BF45E4FCD972", 
             ...
             "CTT-140682CCEB52") 
# Uninstalled "CTT-8F11AA6622E1", "CTT-515928C2BC39"
...
proj.458.sql.motus <- tagme(projRecv = 458, new = FALSE, update = TRUE)
 ...
 # Kern River Valley Tri-colored Blackbird Study
rec.247.names = paste0(c("rth", "lc4", "canebrake"), ".sql.motus")
