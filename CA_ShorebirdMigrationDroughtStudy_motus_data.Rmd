...
Note most detections were on antenna aimed East (95 true, 108 magnetic) since all the land is North and East of the station.
...
points = readOGR("TagTesting/LEVI LAND CHECK 6-30.kml", "Points")
# This does not seem useful, since time domain data is not stored, afaik
points.gpx = readOGR("TagTesting/LEVI LAND CHECK.gpx", "track_points")
...
leaflet(points) %>%
  ...
  addLayersControl(
    ...
    overlayGroups = c("Signal Strength"),
